...
- Benchmark JSON: `matcher_benchmark_de2de57_20260522T185157Z.json`
- Git rev: `de2de57`
- Sample size: 184; flagged: 73 (39.7%)
...
- Justification: "Peanut flour defatted and salted best matches raw peanuts; no exact defatted salted flour available, but same commodity family and base ingredient."
...
- Justification: "Tilefish not in candidates; anglerfish is a raw marine fish, closest in processing and group despite species difference."
- Quality checks: group=False  magnitude=False  token=False

### food_id=5290 — Tea, instant, unsweetened, powder, decaffeinated

- CNF group: `Beverages`
- Matched: `False`  confidence: 0.50
- Matched ciqual: `18020`  → "Tea, brewed, without sugar"
- Matched Agribalyse group: `boissons`
- Justification: "Closest match is brewed tea without sugar; no instant decaf tea available, so brewed tea is a stretched proxy for instant decaf tea powder."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Same commodity family (crab), similar cooking method (boiled), though not specified as Alaska king crab, closest match available."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `produits sucrés`
- Justification: "Dulce de leche is a milk-based sweet similar in dairy content and caramel flavor, closest proxy despite different processing and form."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Duck leg is closest poultry meat with skin, similar cooking state; emu is poultry but no exact match available."
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Dry sausage is the closest meat-based processed snack, though beef jerky is dried meat, not sausage; no exact jerky match available."
- Quality checks: group=False  magnitude=False  token=False
...
- Justification: "Chocolate puffed/popped wheat grain cereal closely matches Krave's chocolate cereal form and processing, minor differences in exact recipe and fortification."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `produits sucrés`
- Justification: "Icing mix mainly sugar; closest proxy is white sugar despite missing other ingredients and processing differences."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Pork and beef mortadella is a cooked, emulsified sausage similar to bologna; closest match despite no explicit reduced fat variant."
- Quality checks: group=True  magnitude=True  token=False
...
- Justification: "Closest match: plant-based patty from lentil, soybean, vegetables aligns well with vegetarian meat loaf, legume-based, minor processing differences."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Game pâté is the closest available game meat option, though processed; no raw whale or similar game meat present in candidates."
- Quality checks: group=False  magnitude=False  token=False
...
- Justification: "Matches baby vegetable dish with meat/fish and starch, closest to beef with vegetables baby food, minor age/form differences."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Closest match is almond, unpeeled; toasted unblanched almonds differ slightly but same commodity family and similar processing."
...
- Matched Agribalyse group: `produits sucrés`
- Justification: "Closest proxy is fruit jelly; no exact frozen vanilla pudding pop match; both are sweet, gelatinous desserts but differ in form and ingredients."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Red kidney bean, canned, drained closely matches baked canned beans in form and processing, same legume family, minor differences in salt content."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Yambean is a tuber similar to yam; boiled yam is closest match in form and processing despite botanical differences."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Frozen courgette/zucchini is closest in processing and form to frozen crookneck squash; both are summer squashes, minor varietal difference."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Beef burger patty, 15% fat, raw is closest to ground beef patty before pan-frying; fat content matches medium ground beef."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Chicken drumstick raw is the closest poultry raw meat match to emu drum, despite species difference."
- Quality checks: group=True  magnitude=True  token=False
...
- CNF group: `Finfish and Shellfish Products`
- Matched: `False`  confidence: 0.40
- Matched ciqual: `27017`  → "Brown bullhead, raw"
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Brown bullhead is a freshwater fish like northern pike; no exact pike liver match, so this is a stretched proxy within freshwater finfish."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `produits céréaliers`
- Justification: "Closest match is wheat flakes with nuts, similar granola style; lacks hemp but matches breakfast cereal with nuts and fortification."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Closest match is dried coconut kernel; desiccated sweetened canned coconut differs in processing and added sugar but same base ingredient."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Closest single nut match; oil roasted mixed nuts not available, so hazelnut alone is a stretched proxy for nuts, oil roasting not specified."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `lait et produits laitiers`
- Justification: "Exact match for goat's milk yogurt, plain, similar fat content; closest to CNF entry in composition and processing."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `lait et produits laitiers`
- Justification: "Plant-based spread-cheese with soybean is closest legume-based spread; others are sandwiches or different products."
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Beef rump steak raw is closest cut to rump roast; both are whole muscle beef cuts, though raw vs broiled differs, still same commodity family and similar composition."
- Quality checks: group=True  magnitude=False  token=True
- GW per 100g: matched=2.8899999999999997  cnf_default=10.0  ratio=0.29x
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Exact match: chickpeas, canned, drained; same commodity and processing state as CNF entry."
- Quality checks: group=True  magnitude=False  token=False
...
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Exact match on burrito; similar processing and ingredients (beans, cheese) in fast food context."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Canned sweet corn closest to canned hominy; both are processed canned maize products, though hominy is nixtamalized, not sweet corn."
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Closest proxy is canned pumpkin pulp, as no commercial pumpkin pie LCI exists; canned form better approximates processed pumpkin in pie than raw or cooked."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Sunflower seed is the closest commodity to safflower seed meal; both are oilseeds, but safflower meal is defatted, unlike whole sunflower seeds."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Peanut, grilled, salted closely matches dry roasted peanuts in mixed nuts; same nut and similar roasting/salting process, though lacks mix component."
- Quality checks: group=True  magnitude=False  token=False
...
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Sauerkraut with garnish closely matches canned sauerkraut; minor difference in garnish presence, same processing and form."
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Closest in commodity (beet family) and cooked state, but matches beetroot not beet greens; acceptable proxy given lack of leafy beet entry."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Closest organ meat match (kidney) though different organ; no pancreas entry available; same animal and raw or lightly cooked form."
- Quality checks: group=False  magnitude=False  token=False
...
- Justification: "Exact match for bay leaf, same commodity and form, minor differences possible in drying or provenance."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Lima bean raw is the closest legume in raw form; pinto and lima beans are similar in use and composition, though not identical species."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Pork lungs not available; pork brain braised is closest organ meat, similar processing but different organ, so only a stretched proxy."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Raw chestnut is the closest match; roasting differs but same commodity, suitable proxy for roasted Chinese chestnuts."
- Quality checks: group=True  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Cooked ham, choice, rind less and fatless is closest to cured, roasted ham shank; minor differences in rind and fat presence reduce confidence slightly."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `matières grasses`
- Justification: "Soy oil is the closest match to industrial soybean shortening, sharing the same commodity family despite processing differences."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Same species (European pilchard/sardine), canned in oil, drained; closest to Atlantic sardine canned in oil with bones, minor regional/species difference."
- Quality checks: group=True  magnitude=False  token=True
...
- Matched Agribalyse group: `fruits, légumes, légumineuses et oléagineux`
- Justification: "Walnut, dried, husked is the closest match in commodity and form; glazing is a coating but no exact glazed walnut available."
- Quality checks: group=True  magnitude=False  token=False
...
- Matched ciqual: `17420`  → "Soy oil"
- Matched Agribalyse group: `matières grasses`
- Justification: "Soy oil is the closest single ingredient proxy for imitation soybean mayonnaise fat base, though processing and formulation differ."
- Quality checks: group=True  magnitude=True  token=False

### food_id=4954 — Chicken nuggets, macaroni in cheese sauce, corn in a seasoned sauce and chocolate pudding, frozen

- CNF group: `Mixed Dishes`
- Matched: `False`  confidence: 0.40
- Matched ciqual: `25198`  → "Pasta with cheese sauce (spaghetti, tagliatelle…)"
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Closest match is pasta with cheese sauce; chicken nuggets and corn not represented, so only partial proxy for macaroni in cheese sauce component."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Hot-dog is the closest match to corn dog with sausage and coating, though lacks cornflour batter and frozen state details."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched ciqual: `31044`  → "Sugar, vanilla flavoured"
- Matched Agribalyse group: `produits sucrés`
- Justification: "No exact ice cream match; sugar vanilla flavored closest but lacks dairy and frozen fat-free characteristics."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `viandes, œufs, poissons`
- Justification: "Golden redfish is the closest species match to goldeye; both are raw finfish but differ in species and likely provenance."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `produits céréaliers`
- Justification: "Corn flakes, sugar iced, fortified closely match Special K's processed, fortified cereal profile despite different grain base."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Meat balls with tomato sauce closely match sweet and sour meatballs in form and main ingredient, despite sauce flavor difference."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `produits sucrés`
- Justification: "Closest generic candy category; no exact crystallized ginger match; composition and processing differ but still within sweets group."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `produits céréaliers`
- Justification: "Wholemeal rolls closest to pumpernickel rolls; similar grain base and form, though pumpernickel is denser and darker, so not exact but best available match."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `entrées et plats composés`
- Justification: "Shepherd's pie with meat is a similar meat-based savory pie, close in processing and dish type to turkey pot pie, though different meat used."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `matières grasses`
- Justification: "Closest match is blended fat of vegetable and animal origin, reflecting creamy dressing fat base, though no exact sour cream/buttermilk dressing available."
- Quality checks: group=False  magnitude=False  token=False
...
- Matched Agribalyse group: `produits céréaliers`
- Justification: "Closest match is puffed wheat cereal with sweetener; Life Toasted Cinnamon is a toasted, sweetened wheat cereal, similar processing and form."
- Quality checks: group=True  magnitude=True  token=False
...
- Matched Agribalyse group: `matières grasses`
- Justification: "Italian salad dressing often uses olive oil as base fat; closest Agribalyse entry is extra virgin olive oil, though dressing includes other ingredients."
- Quality checks: group=True  magnitude=True  token=False
