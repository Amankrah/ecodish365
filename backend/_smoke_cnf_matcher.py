...
PANEL_A = [
    ...
    QueryProbe('A', 'Yogourt, plain, fat-free', {6948}, min_confidence=0.85,
               note='French CNF spelling (Yogourt) of plain yogurt (CNF 2026 code)'),
...
PANEL_C = [
    ...
    QueryProbe('C', 'fat-free Greek yogurt',
               expected_food_ids={6979, 6980, 6981},
               min_confidence=0.6, note='Greek / plain / fat-free yogurt family (CNF 2026 codes)'),
...
PANEL_D = [
    ...
    QueryProbe('D', 'homemade beef stew',
               expected_food_ids={4964, 6775, 6776},
               min_confidence=0.4, accept_in_alternatives=True,
