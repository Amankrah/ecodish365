    ...
    explanations = {
        ...
        "policy": {
            "monetization": {
                ...
                "detailed_explanation": "Monetized impacts provide policy-relevant cost estimates for regulatory impact assessment, carbon pricing mechanisms, and public investment decisions. Climate cost uses CAD 275 / tonne CO₂-eq from the ECCC 2023 Social Cost of GHG Guidance (2026 central, 2 % Near-term Ramsey discount, base year 2021 CAD; sensitivity range 170 – 467 across 2.5 % – 1.5 % discount rates); other categories draw on the CE Delft 2018 Environmental Prices Handbook Hierarchist weighting factors (EUR 2015 → CAD 2021 via OECD PPP) with Canadian regional adjustments — see `monetization.py` for per-category sources and the `monetary_value_sources` audit trail for page anchors.",
