                ...
                <div className="p-6 pt-0 space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {userType === 'individual'
                        ? 'Search and select foods to see their environmental footprint.'
          ...
          <TabsContent value="analysis" className="space-y-6">
            {environmentalResults && (
              <>
                ...
                {userType !== 'individual' && environmentalResults.data?.meal_analysis?.lca_matcher?.enabled && (
                ...
                <div className="grid lg:grid-cols-2 gap-6 mb-6">
                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle>{userType === 'individual' ? 'Environmental impact' : 'LCA Impact Breakdown'}</CardTitle>
                    </CardHeader>
                    <CardContent>
