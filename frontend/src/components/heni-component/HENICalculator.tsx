...
const HENICalculator = () => {
  ...
  const calculateHENI = async () => {
    ...
    try {
      ...
      const response = await HENIApiService.calculateHENI({ meal });
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card className="shadow-lg">
                ...
                <CardContent>
                  ...
                  {heniResults ? (
                    <HENIResultsCard results={heniResults} compact />
                  ) : (
              ...
              <>
                ...
                <div className="grid lg:grid-cols-5 gap-6 mb-6">
                  <Card className="lg:col-span-3 shadow-lg">
                    ...
                    <CardContent>
                      <HENIResultsCard results={heniResults} detailed />
                    </CardContent>
                  </Card>
                  ...
                  <CardContent>
                    <div className="prose prose-sm max-w-none">
                      <p className="text-gray-600 mb-4">
                        Your HENI score is calculated using the Global Burden of Disease methodology,
                        which quantifies health impacts in <strong>micro-DALYs (μDALYs)</strong>. 
                        One μDALY = 0.5256 minutes of healthy life impact. Positive scores indicate health benefits, 
                        negative scores indicate health risks. This evidence-based approach considers:
                      </p>

                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <h5 className="font-semibold mb-2">14 Risk Factors Analyzed:</h5>
                          <ul className="space-y-1 text-gray-600">
                            <li>• 8 Food Groups (fruits, vegetables, etc.)</li>
                            <li>• 6 Key Nutrients (omega-3, fiber, etc.)</li>
                          </ul>
                        </div>

                        <div>
                          <h5 className="font-semibold mb-2">Disease Impacts Considered:</h5>
                          <ul className="space-y-1 text-gray-600">
                            <li>• Cardiovascular diseases (65%)</li>
                            <li>• Various cancers (20%)</li>
                            <li>• Metabolic disorders (15%)</li>
                          </ul>
                        </div>
                      </div>
