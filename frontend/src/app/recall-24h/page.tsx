            ...
            <div className="flex-1">
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <h1 className="text-2xl font-bold text-gray-900">
                  {userType === 'individual' ? 'Food diary' : '24-hour dietary recall'}
                </h1>
                <a
                  href="/recall-history"
                ...
                >
                  ...
                  {userType === 'individual' ? 'My food diary' : 'My recall history'}
                </a>
              </div>
              <p className="text-sm text-gray-600 mt-1">
                {userType === 'individual' ? (
                  <>
                    Walk through your day meal by meal. Describe what you ate in free text or{' '}
                    <strong>photograph packaged foods</strong> (breakfast cereal, snack bar, canned soup).
                    We break each meal into ingredients, add up your full day, and let you score it.
                  </>
                ) : (
                  <>
              ...
              {userType === 'individual' && (
              <p className="text-xs text-gray-500 mt-2">
                Works best for a full day of eating. Save days to{' '}
                <a href="/recall-history" className="text-amber-800 underline">your food diary history</a>{' '}
                so you can score or compare them later.
              </p>
              )}
            </div>
          </div>
